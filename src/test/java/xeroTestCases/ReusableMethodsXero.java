...
public class ReusableMethodsXero {
	public static boolean enterText(WebElement obj, String txtval, String objName) {
		if (obj.isDisplayed()) {
			obj.sendKeys(txtval);
			DriverFileXero.logger.log(Status.INFO,"Pass: " + txtval + " is entered in " + objName + "  field");
			return true;
		} else {
			DriverFileXero.logger.log(Status.INFO,"Fail: " + objName + "field doesnot exist please check your application");
			return false;
		}
	...
	public static boolean Clear(WebElement obj,String objName) {
		if (obj.isDisplayed()) {
			obj.clear();
			DriverFileXero.logger.log(Status.INFO,"Pass: " + objName +" is displayed and the field  is cleared");
			return true;
		}
		else {
			DriverFileXero.logger.log(Status.INFO,"Fail: " + objName +" field doesnot exist please check your application");
	...
	public static boolean clickObject(WebElement obj, String objName) {
		if (obj.isDisplayed()) {
			obj.click();
			DriverFileXero.logger.log(Status.INFO,"Pass: " + objName + " is clicked");
			return true;
		} else {
			DriverFileXero.logger.log(Status.INFO,"Fail: " + objName + "field doesnot exist please check your application");
			return false;
	...
	public static boolean selectCheckBox(WebElement obj, String objName) {
		if (obj.isDisplayed()) {
			if(obj.isSelected())
			{
				DriverFileXero.logger.log(Status.INFO,"Pass: " + objName + " is previously clicked");
				return true;
			}
			else
			obj.click();
			DriverFileXero.logger.log(Status.INFO,"Pass: " + objName + " is now clicked");
			return true;
		}
			else {
			DriverFileXero.logger.log(Status.INFO,"Fail: " + objName + "field doesnot exist please check your application");
	...
	public static boolean deSelectCheckBox(WebElement obj, String objName) {
		if (obj.isDisplayed())
		{
			...
			{
				obj.click();
				DriverFileXero.logger.log(Status.INFO,"Pass: " + objName + " is checked");
				return true;
			} else {
				DriverFileXero.logger.log(Status.INFO,"Fail: " + objName + "field doesnot exist please check your application");
				return false;
	...
	public static boolean validateTextBoxContent(WebElement obj, String expectedText, String objName){
		if(obj.isDisplayed())
		{
			...
			if(expectedText.equals(actualText)){
				DriverFileXero.logger.log(Status.INFO,"Pass: " + " Expected text '" + expectedText + "' is matching with actual text: '" + actualText + "'.");
				return true;
			} else {
				DriverFileXero.logger.log(Status.INFO,"Fail: "+" Expected text '" + expectedText + "' is not matching with actual text '"+ actualText + "'.");
				return false;
						}
			
		}else{
			DriverFileXero.logger.log(Status.INFO,"Fail: " + objName + " is not diplayed, please check your application");
			return false;
		}
